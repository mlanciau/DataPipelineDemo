...
virtualenv_dir=/Users/mlanciau/cron/grab_twitter_postgresql
...
python3 -m pip install -r ${user_dir}/Documents/GitHub/DataPipelineDemo/grab_twitter_postgresql/requirements.txt
